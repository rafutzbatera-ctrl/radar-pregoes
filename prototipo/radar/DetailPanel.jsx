...
// Sob modo estático/reduzido: condicional simples, SEM AnimatePresence (remoção imediata garantida).
...
function PainelConteudo({ item, pregao, fechar, setCusto, setMatch, config, fecharRef }) {
        ...
        <section className="painel-bloco">
          ...
          <div className="painel-grid">
            <div className="painel-kv">
              ...
              <div className="v">Menor preço</div>
            </div>
            <div className="painel-kv">
              <div className="silk">Benefício ME/EPP</div>
              <div className="v">{pregao.meEpp ? "Sim" : "Não"}</div>
            </div>
            <div className="painel-kv">
            ...
            <div className="painel-kv">
              ...
              <div className="v">{sigiloso ? "sigiloso" : fmtBRL(item.unit)}</div>
            </div>
          </div>
        </section>
            ...
            <div className="painel-match">
              <div className="painel-match-top">
                <div>
                  ...
                  <div className="painel-fonte">{item.produto.cod} · {item.produto.cat}</div>
                </div>
              ...
              {!item.coberto && setMatch && (
                <div className="painel-match-acoes">
                  <button type="button" className="match-btn ok" onClick={() => setMatch(item.n, { ...m, confirmado: true })}>{Ico.check} Confirmar match</button>
              ...
              {!sigiloso && (
                <div className="painel-custo">
                  <div className="painel-custo-linha">
                    ...
                    <CostInput item={item} setCusto={setCusto} />
                  </div>
                  <div className="painel-custo-linha">
...
function DetailPanel({ item, pregao, fechar, setCusto, setMatch, config }) {
  ...
  if (estatico) {
    ...
    return (
      <React.Fragment>
        ...
        >
          <PainelConteudo item={item} pregao={pregao} fechar={fechar} setCusto={setCusto} setMatch={setMatch} config={config} fecharRef={fecharRef} />
        </aside>
      </React.Fragment>
    );
  }
...
Object.assign(window, { DetailPanel, useIsMobile, PainelConteudo });
